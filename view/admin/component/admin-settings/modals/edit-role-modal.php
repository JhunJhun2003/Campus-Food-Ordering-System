    ...
    <div class="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto p-6 shadow-2xl">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-slate-900">
                <i class="fa-solid fa-pen text-indigo-500 mr-2"></i> Edit Role
            </h2>
        ...
        <form method="POST" action="/Campus-Food-Ordering-System/access-control/update-role">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="edit_role_name" name="name" 
                       required class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-indigo-500 text-sm">
            </div>
            <div class="flex space-x-2">
                <button type="button" class="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold py-2.5 rounded-lg transition-colors text-sm" onclick="closeModal('editRoleModal')">
                    Cancel
                </button>
