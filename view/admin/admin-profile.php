...
<head>
    ...
    <title>Admin Profile - Foodie</title>
    ...
    <aside class="w-64 bg-white border-r border-slate-100 flex flex-col justify-between py-6 flex-shrink-0">
        <div>
            ...
            <nav class="space-y-1 px-3">
                ...
                <a href="admin-profile.php" class="sidebar-link active flex items-center space-x-4 px-4 py-3 rounded-lg font-medium transition-colors relative">
